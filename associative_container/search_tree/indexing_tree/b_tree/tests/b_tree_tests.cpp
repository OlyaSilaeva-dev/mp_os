...
//    return RUN_ALL_TESTS();
    ...
    allocator alloc;
    logger log;
    b_tree<int, std::string> tree(2, [](int const &a, int const &b) { return a - b; }, &alloc, &log);
    tree.insert(10, "value1");
    tree.insert(20, "value2");
    tree.insert(5, "value3");
    tree.insert(6, "value4");
    tree.insert(12, "value5");

    // Test copy constructor
    b_tree<int, std::string> tree_copy(tree);

    // Test copy assignment
    b_tree<int, std::string> tree_copy_assign(2, [](int const &a, int const &b) { return a - b; }, &alloc, &log);
    tree_copy_assign = tree;

    // Test move constructor
    b_tree<int, std::string> tree_move(std::move(tree));

    // Test move assignment
    b_tree<int, std::string> tree_move_assign(2, [](int const &a, int const &b) { return a - b; }, &alloc, &log);
    tree_move_assign = std::move(tree_copy);
